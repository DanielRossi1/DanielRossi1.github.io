...
- Peripheral mounting and camera management

The project has already gained **36 stars** and **4 forks** on GitHub, with active community contributions.

**Repository**: [github.com/danielrossi1/AutoDock](https://github.com/danielrossi1/AutoDock)  
**Documentation**: [AutoDock Docs](https://danielrossi1.github.io/AutoDock)
