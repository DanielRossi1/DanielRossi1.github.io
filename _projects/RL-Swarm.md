...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid path="assets/img/projects/RLSwarm/RLSwarm.png" title="RL-Swarm Simulation" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
...
$$ R*t = \alpha \cdot R*{coverage} + \beta \cdot R*{pheromone} + \gamma \cdot R*{coordination} - \delta \cdot R\_{collision} $$
...
<div class="repositories d-flex flex-wrap flex-md-row flex-column justify-content-between align-items-center">
    <div class="repo p-2 text-center">
        <a href="https://github.com/DanielRossi1/RL-swarms" class="btn btn-primary z-depth-1">
